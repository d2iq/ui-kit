...
interface NonMenuDropdownProps
...
const NonMenuDropdown: React.StatelessComponent<NonMenuDropdownProps> = ({
  children,
  "data-cy": dataCy,
  id,
  initialIsOpen,
...
NonMenuDropdown.defaultProps = {
  ["data-cy"]: "nonMenuDropdown"
};

export default NonMenuDropdown;
